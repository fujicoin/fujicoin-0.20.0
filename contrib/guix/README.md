...
- 24GB of free disk space on the partition that the Fujicoin Core git repository
  resides in
...
For a Fujicoin Core depends development environment, simply invoke
...
From the top of a clean Fujicoin Core repository:
...
To use dongcarl's substitute server for Fujicoin Core builds after having
