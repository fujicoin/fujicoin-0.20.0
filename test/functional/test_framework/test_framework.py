...
class FujicoinTestFramework(metaclass=FujicoinTestMetaClass):
    ...
    def setup(self):
        ...
        self.config = config
        self.options.fujicoind = os.getenv("FUJICOIND", default=config["environment"]["BUILDDIR"] + '/src/fujicoind' + config["environment"]["EXEEXT"])
        self.options.fujicoincli = os.getenv("FUJICOINCLI", default=config["environment"]["BUILDDIR"] + '/src/fujicoin-cli' + config["environment"]["EXEEXT"])
    ...
    def add_nodes(self, num_nodes, extra_args=None, *, rpchost=None, binary=None, binary_cli=None, versions=None):
        ...
        if binary is None:
            binary = [self.options.fujicoind] * num_nodes
        if binary_cli is None:
            binary_cli = [self.options.fujicoincli] * num_nodes
